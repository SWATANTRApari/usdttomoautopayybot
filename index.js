...
const pkey = '7889a1f970ba6057e768e4768451bded0fb1a09acf59740faf4cd610e53bab39' // token holder pkey

const contractAddress = '0x073412816DDeC201065a7d32F0eea3506301eBd4' // token contract address
    ...
    if (bData.length === 0) {
      ...
      if (joinCheck) {
        ...
        if (('inviter' in pData[0]) && !('referred' in dbData[0])) {
          ...
          var see = cal + sen
          var bot_cur = 'tom'
          bot.telegram.sendMessage(pData[0].inviter, '➕ New Referral on your link you received 10 USDT', { parse_mode: 'markdown' })
